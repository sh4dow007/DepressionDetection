...
proc vTcl:setup {} {
    ...
    # Removed from above  tclet.tcl attrbar.tcl
...
# } ;# end if
    ...
    bind vTcl(b) <Alt-Button-3>  {vTcl:bind_button_multi %W %X %Y %x %y}
...
# }
    ...
    set vTcl(project_directory) [file dirname $file]
    set vTcl(initialdir) $vTcl(project_directory)
    vTcl:setup
